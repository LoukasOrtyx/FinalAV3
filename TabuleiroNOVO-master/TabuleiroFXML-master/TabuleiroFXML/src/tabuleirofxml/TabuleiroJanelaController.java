...
public class TabuleiroJanelaController implements Initializable {
        ...
        this.TrataCliqueDoMouse = new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                if(event.getSource() instanceof ImageView) {//LEMBRAR BOTAR COMER
                    ...
                    System.out.println("o evento é de imageView " + (cont++));
                    if(pegou==false){
                        System.out.println("peça nova " + (cont++));
                        xvelho=((Peça) event.getSource()).getCoordX();
                        yvelho=((Peça) event.getSource()).getCoordY();
                        pegou=true;
                    } else if(pegou == true && Tab.CasaÉVermelha(((Peça) event.getSource()).getCoordX(), ((Peça) event.getSource()).getCoordY())) {
                         Peça aux;
                         voltaCor(Tab);
                         Tab.RemoverPeça(((Peça) event.getSource()).getCoordX(), ((Peça) event.getSource()).getCoordY());
                        try {
                            nomePeca= Tab.getCasaEspecifica(xvelho, yvelho).getUnidade().getNome();
                        ...
                        switch(nomePeca){
                            case 'B':
                                aux = new Bolsonaro(0, ((Peça) event.getSource()).getCoordX(), ((Peça) event.getSource()).getCoordY());
                               ...
                               voltaCor(Tab);
                                break;
                            case 'C':
                                aux = new Cajahyba(0, ((Peça) event.getSource()).getCoordX(), ((Peça) event.getSource()).getCoordY());
                                
                                Tab.InserirPeça(((Peça) event.getSource()).getCoordX(), ((Peça) event.getSource()).getCoordY(), aux);
                            ...
                            case 'T':
                                 aux = new Tridente(0, ((Peça) event.getSource()).getCoordX(), ((Peça) event.getSource()).getCoordY());
                    ...
                    if(!removeuagr){
                      System.out.println(event.getSource());
                        System.out.println("é Peça" + (cont++));
    ...
    public void TreatMovements(Peça Unidade, Tabuleiro Tab) {
        ...
        ArrayList <Integer> AllCapturas, CapturasVálidas = new ArrayList();
        int i, x, y;
        int All = -1;
        
        AllCapturas = Unidade.TraçarCaptura(All, All);
        AllTrajetos = Unidade.TraçarCaminhos(All, All);
        
        TrajetosVálidos = Tab.ChecarCadaRumo(AllTrajetos);
        
        CapturasVálidas = Tab.ChecarCadaCaptura(AllCapturas);
        ...
        for(i = 0; i < CapturasVálidas.size(); i += 2) {
            
            x = CapturasVálidas.get(i);
            y = CapturasVálidas.get(i + 1);
            
            if (x % 2 == 0 && y % 2 == 0 || x % 2 != 0 && y % 2 != 0) {
                
                if(Tab.getCasas()[x][y].getFill().equals(Color.DARKGREEN) || Tab.getCasas()[x][y].getFill().equals(Color.LIGHTGREEN)) {
                    
                    Tab.getCasas()[x][y].setFill(Color.BROWN); 
                } else {
                    Tab.getCasas()[x][y].setFill(Color.DARKRED);
                }    
            } else {
                ...
                Tab.getCasas()[x][y].setFill(Color.BROWN);
                    ...
                    Tab.getCasas()[x][y].setFill(Color.LIGHTCORAL);
                } 
            } 
        }
    }
